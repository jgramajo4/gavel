  ...
  return {
    ...
    async getTransaction(safeTxHash) {
      ...
      const full = {
        ...
        safeTxGas: body.safeTxGas ?? "0",
        baseGas: body.baseGas ?? "0",
        gasPrice: body.gasPrice ?? "0",
        gasToken: body.gasToken ?? "0x0000000000000000000000000000000000000000",
        refundReceiver: body.refundReceiver ?? "0x0000000000000000000000000000000000000000",
