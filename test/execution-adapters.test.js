  ...
  return {
    ...
    async getTransaction(safeTxHash) {
      ...
      return {
        ...
        safeTxGas: overrides.statusSafeTxGas ?? "0",
        baseGas: overrides.statusBaseGas ?? "0",
        gasPrice: overrides.statusGasPrice ?? "0",
        gasToken: overrides.statusGasToken ?? "0x0000000000000000000000000000000000000000",
        refundReceiver: overrides.statusRefundReceiver ?? "0x0000000000000000000000000000000000000000",
