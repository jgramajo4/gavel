...
```bash
node gavel/nouns-dao/scripts/get_auction.js
node gavel/nouns-dao/scripts/get_noun_metadata.js
node gavel/nouns-dao/scripts/list_proposals.js --limit=10
```
...
```bash
node gavel/nouns-dao/scripts/place_bid.js --amount-eth 50
node gavel/nouns-dao/scripts/settle_auction.js
node gavel/nouns-dao/scripts/propose.js --targets ... --values ... --signatures ... --calldatas ... --description ...
```
