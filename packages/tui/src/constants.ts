...
export const DEFAULTS = {
  ...
  // The public governance index, which answers a proposal list in one request.
  // Must match DEFAULT_INDEX_API_URL in packages/governance-index.
  INDEX_API_URL: 'https://index.0773h.com',
} as const;
